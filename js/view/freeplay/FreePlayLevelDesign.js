...
define( function( require ) {
  ...
  function LevelDesign() {
    ...
    this.getLevels = function() {
      return [
        new FreeplayLevel( 'Quest for the Crystal Fractal\n\n' +
                           'Day 1:\n' +
        ...
        new FreeplayLevel( 'In Cairo, my companion lost her passport\nbut I filled in.', [ createTriangle() ], [
          new RadialDoubling()
        ], [
          new Snowflake(),
          new DeleteVertices( 3 ),
        ...
        new FreeplayLevel( 'Chased by nazi werewolves,\n' +
        ...
        , new FreeplayLevel( 'The tomb was cursed--\n' +
        ...
        , new FreeplayLevel( 'If I walk amongst the mummies,\n' +
        ...
        , new FreeplayLevel( 'At last, the locked chamber.\n' +
        ...
        new FreeplayLevel( 'Finally! The crystal fractal is mine--\n' +
